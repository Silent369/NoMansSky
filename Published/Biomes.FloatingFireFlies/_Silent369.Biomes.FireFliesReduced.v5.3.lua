local modfilename = "FireFliesReduced"
...
------------------------------------------------------------------------------
local heavy_partcnt = 0.3  -- Modifies the number of heavyair particles
local heavy_speed_v = 1.1  -- Modifies the visible speed of particles
local heavy_radi_xy = 0.5  -- Modifies the particles radius / radiusY
local heavy_plife_t = 8.1  -- Modifies particles Min / Max lifetime
local heavy_fades_m = 0.6  -- Modifies fade speed of rendered particles
local heavy_scale_m = 0.8  -- Modifies the x,y,z particles scale ranges
local heavy_rotat_r = 0.5  -- Modifies the rotational range of particles
------------------------------------------------------------------------------
local fogstrength   = 0.1  -- Modifies fogstrength
local fogmax        = 0.1  -- Modifies fogmax
local fogheight     = 0.1  -- Modifies fogheight
------------------------------------------------------------------------------
