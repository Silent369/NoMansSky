...
------------------------------------------------------------------------------
local heavy_a = 0.5    -- Modifies all heavyair for all weather types.
local foggy_a = 0.5    -- Modifies all fog for all weather types.
------------------------------------------------------------------------------
        ...
        EXML_CT = {
            {
                ...
                SECTION_UP = 1,
                ITF = "FORCE",
                VCT = {{"CloudRatio", "0.75"},} --Original "0.55"
            },
            {
