...
local mbin_files = {
    [[METADATA\SIMULATION\SOLARSYSTEM\WEATHER\SKYSETTINGS\SPACERARESKYCOLOURS.MXML]],
    [[METADATA\SIMULATION\SOLARSYSTEM\WEATHER\SKYSETTINGS\SPACESKYCOLOURS.MXML]]
}
...
local SpaceColours = {
    ...
    NebulaColour1      = random_rgb_vector(colourStr, 0.8),
    NebulaColour2      = random_rgb_vector(colourStr, 0.6),
    NebulaColour3      = random_rgb_vector(colourStr, 0.4),
