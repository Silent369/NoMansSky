...
AddSentinCrash = CreateScannableComponentData(_ScanRange, "UI_CRASH_REVEAL_MARKER",      _ScanTime, _RangeMult, _ShowRange, "Drone",              "True") --Changed to correct tip UI_SENTINEL_CRASH_MARKER
    ...
    {
        {
            ...
            {
                    ----------------------------------------------------------------------------------------------
                    --SENTINEL CRASH SCENE - DOES NOT APPEAR TO WORK!
                    ----------------------------------------------------------------------------------------------
                {
                    ...
                    {
                        {
                            PKW = {"Components"},
                            CREATE_HOS = true,
                            ADD = PhysicsComponantData,
                        },
                        {
                            SKW = {"Template", "TkPhysicsComponentData.xml"},
                            SECTION_UP = 1,
                            ADD_OPTION = "ADDafterSECTION",
                            ADD = AddSentinCrash..DistressSound
                        },
                    }
                },
                    ----------------------------------------------------------------------------------------------
