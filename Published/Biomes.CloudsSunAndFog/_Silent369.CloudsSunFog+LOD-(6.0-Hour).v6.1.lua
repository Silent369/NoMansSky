local modfilename = "CloudsSunAndFog-(6.0-Hour)"
local lua_author  = "Silent"
local lua_version = "6.1"
...
LOD settings are now merged back into the main script which have been modified again to
adjust for Low, Medium, High and Ultra settings.
...
local m_Day_Length  = 21600 --Original "1800"

--CLOUD ANIM SPEED
local m_Anim_Scale  = 150  --Original "50"

--Fog Height/Strength Control
--Valid ranges: (0.0-1.0)
local m_FogSControl = 0.5  -- Fog Strength
local m_FogHControl = 0.6  -- Fog Height
...
local m_Intensity               = 3.2  --Original "3"
...
local m_HorizonDistance         = 11165 --Original "11165"
...
--Fog Height
local m_HeightFogHeightMin      = -3   * m_FogSControl  --Original "100"
local m_WaterAlphaHeightMin     = 20   * m_FogSControl  --Original "40"
            ...
            MBIN_CT =
            {
                ...
                },
                {
                    ...
                    MXML_CT =
                    {
                        ...
                        ----------------------------------------------------------------------------
                        {
                            ...
                            VCT = {
                                {"LightShaft Scattering",    "0.45"}, --Original "0.55"
                ...
                ----------------------------------------------------------------------------
                {
                    ...
                    MXML_CT =
                    {
                        ...
                        ----------------------------------------------------------------------------
                        --LOD Value Changes (Low, Medium, High, Ultra)
                        ----------------------------------------------------------------------------
                        {
                            SKW = {"Low","TkLODSettingsData"},
                            PKW = {"LODAdjust"},
