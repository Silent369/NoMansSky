...
local waterValues = {
    WaveHeight            = 1.2,   -- 1.5
    WaveFrequency         = 1.0,   -- 0.01
    WaveChoppiness        = 0.5,   -- 2
    FresnelPow            = 2,     -- 4
    FresnelMul            = 0.1,   -- 0.3
    FresnelAlpha          = 0.3,   -- 0.5
    FresnelBelowPow       = 2,     -- 4
...
local waterDataValues = {
    ...
    WaterMultiplyStrength = 0.04,  -- 0.3
    WaterMultiplyMax      = 0.2,   -- 0.9
    FresnelPower          = 2,     -- 4
    FresnelMin            = 1.3,   -- 1.4
    FresnelMax            = 1.0,   -- 0.7
    ...
    NormalMap1Scale       = 0.03,  -- 0.02
    NormalMap1Speed       = 0.03,  -- 0.01
    NormalMap2Scale       = 0.02,  -- 0.01
    NormalMap2Speed       = 0.014, -- 0.012
    Foam1Scale            = 0.6,   -- 0.08
    Foam1Speed            = 0.06,  -- 0.02
    Foam2Scale            = 0.3,   -- 0.5
    Foam2Speed            = 0.12,  -- 0.04
}

local metaWaterValues = {
    MinimumWavelength     = 0.32,  -- 0.08
