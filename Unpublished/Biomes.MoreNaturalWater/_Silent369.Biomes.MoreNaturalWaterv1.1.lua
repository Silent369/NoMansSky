...
local waterDataValues = {
    WaterStrength         = 0.04,  -- 0.01
    WaterColourStrength   = 0.002, -- 0.008
    WaterMultiplyStrength = 0.02,  -- 0.3
    WaterMultiplyMax      = 0.3,   -- 0.9
    FresnelPower          = 2,     -- 4
    FresnelMin            = 1.3,   -- 1.4
    FresnelMax            = 0.6,   -- 0.7
    Wave1Scale            = 0.02,  -- 0.01
    Wave1Height           = 0.7,   -- 1.3
    Wave1Speed            = 0.03,  -- 0.04
    Wave2Scale            = 0.02,  -- 0.01
    Wave2Height           = 1.2,   -- 1.8
    Wave2Speed            = 0.02,  -- 0.03
    NormalMap1Scale       = 1,  -- 0.02
    NormalMap1Speed       = 0.008,  -- 0.01
    NormalMap2Scale       = 1,  -- 0.01
